...
- Tests con `npm test` antes de cada commit — incluyen un BFS de alcanzabilidad que valida que los 12 niveles se completan con salto simple (Scrap); si tocas niveles y falla, el nivel quedó imposible sin habilidad aérea.
