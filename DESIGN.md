...
- **Rayos eléctricos** (`EnergyBeam`, array `beams`: `[x, y, longitud, desfase]`): el préstamo de las pirañas de Super Mario — un peligro periódico que convierte cruzar un hueco en una cuestión de timing. Ciclo fijo de 150 frames (90 apagado, 15 de aviso con chisporroteo en los emisores, 45 activo), daño 4 con la misma tregua de invulnerabilidad que el muro del Túnel. Los emisores se ven siempre (el hueco "se lee" peligroso también apagado) y el desfase alterna los rayos de un mismo nivel. Frames, no tiempo real: determinista en cualquier máquina.
